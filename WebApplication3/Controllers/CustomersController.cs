...
namespace ElectronicsStore.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ElectronicsContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Customer_1.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,AddressLine,City,StateCode,ZipCode")] Customer customer)
        {
